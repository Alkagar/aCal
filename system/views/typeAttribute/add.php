...
<div class="form">
    ...
    <div class="row">
        <div class='form-cell form-label'> <?php echo $activeForm->labelEx($form, 'default'); ?> </div>
        <div class='form-cell'> <?php echo $activeForm->textField($form, 'default'); ?> </div>
        <div class='form-cell'> <?php echo $activeForm->error($form, 'default',  array('class' => 'form-error')); ?> </div>
    </div>
